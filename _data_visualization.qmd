...
![](img/ifn_pattern_by_celltype_split_condition.png){fig-alt="Selected R K6 IFN-associated pattern activity split by PBMC cell type and control or IFN-beta stimulated condition." width=800 .lightbox}
...
![](img/pattern_gene_directionality_heatmap.png){fig-alt="Heatmap showing mean paired stim-versus-control log2 fold changes for top CoGAPS pattern genes from the selected R K6 model." width=600 .lightbox}
